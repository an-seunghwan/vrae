...
#%%
class GubelSoftmaxVAE(K.models.Model):
    def __init__(self, params):
        super(GubelSoftmaxVAE, self).__init__()
        self.params = params
        
        # encoder
        self.enc_dense1 = layers.Dense(512, activation='relu')
        self.enc_dense2 = layers.Dense(256, activation='relu')
        self.enc_dense3 = layers.Dense(params["class_num"]*params["M"])
...
logits_y, logits_x = model(x_train[:100], tau=0.5)
