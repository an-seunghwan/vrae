...
def save_plt(original_img, construct_img, code):
    ...
    for i in range(0, 15, 3):
        ...
        plt.axis('off')
    if PARAMS['FashionMNIST']:
        plt.savefig('./result/mixturevae_fashionmnist_rebuilt_200910.png')
    else:
        plt.savefig('./result/mixturevae_mnist_tsne_200910.png')
...
for i in range(PARAMS['class_num']):
    ...
    plt.tight_layout() 
if PARAMS['FashionMNIST']:
    plt.savefig('./result/mixturevae_fashionmnist_center_200910.png')
else:
    plt.savefig('./result/mixturevae_mnist_center_200910.png')
#%%
'''t-SNE'''
...
if PARAMS['FashionMNIST']:
    plt.savefig('./result/mixturevae_fashionmnist_tsne_200910.png')
else:
    plt.savefig('./result/mixturevae_mnist_tsne_200910.png')
#%%