...
plt.scatter(prior_means[0][:, 0], prior_means[0][:, 1])
#%%
...
for epoch in range(1, PARAMS["epochs"] + 1):
    ...
    for train_x in train_dataset:
        with tf.GradientTape(persistent=True) as tape:
            ...
            loss, mse, kl_loss = gumbel_loss(logits, xhat, train_x, mean, logvar, tau, beta=1)
    ...
    print("MSE:", mse.numpy(), ", KL loss:", kl_loss.numpy(), ", beta:", 1)
    ...
    if epoch % 1 == 0:
        ...
        for test_x in test_dataset:
            ...
            losses.append(gumbel_loss(logits, xhat, test_x, mean, logvar, tau, beta=1)[0].numpy()[0])
