...
for epoch in range(1, PARAMS["epochs"] + 1):
    ...
    for train_x in train_dataset:
        with tf.GradientTape(persistent=True) as tape:
            ...
            loss, bce, kl_loss = gumbel_loss(logits, xhat, train_x, mean, logvar, tau, beta) # gamma
    ...
    print("BCE:", bce.numpy(), ", KL loss:", kl_loss.numpy(), ", beta:", beta)
...
for i in range(len(grid)):
    ...
    plt.axis('off')
    plt.tight_layout() 
    plt.savefig('./result/grid_200917.png', 
