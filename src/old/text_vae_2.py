...
'''감성라벨 데이터'''
# 소비자
sentiment_idx = data['소비자'] != 0 # 경제심리가 있는 문장만을 추출
sentence = data.loc[sentence_idx & sentiment_idx]['content_new'].to_list()
print(len(sentence))
#%%
